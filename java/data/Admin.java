    ...
    private void inputBook() {
        ...
        switch (bookType) {
            case 1:
                ...
                daftarBuku[i++] = new HistoryBook(id, title, stock, author);
                break;
            case 2:
                idBuku = generateId("SB");
                daftarBuku[i++] = new StoryBook(id, title, author, stock);
                break;
            case 3:
                idBuku = generateId("TB");
                daftarBuku[i++] = new TextBook(id, title, author,stock);
                break;
            default:
                System.out.println("Pilihan tidak valid!");
                return;
    ...
    private void displayStudents() {
        ...
        for (Student student : studentList) {
            ...
            if (!student.getBorrowedBooks().isEmpty()) {
                ...
                for (Object book : student.getBorrowedBooks()) {
